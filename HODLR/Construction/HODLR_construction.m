function [ F, HODLR] = HODLR_construction( N, func, funcT, tol, fid, occ, mr_1, mr_2)
...
for lvl=1:nlvl-1
   ...
   if lvl>1
        A_1 = funcT(func(R_1))-HODLR_apply(HODLR,R_1);
        A_2 = funcT(func(R_2))-HODLR_apply(HODLR,R_2);
   else
       A_1 = funcT(func(R_1));
       A_2 = funcT(func(R_2));
   end
   ...
   if lvl>1
        AQ_row = funcT(func(Q_row))-HODLR_apply(HODLR,Q_row);
   else
       AQ_row = funcT(func(Q_row));
   end
